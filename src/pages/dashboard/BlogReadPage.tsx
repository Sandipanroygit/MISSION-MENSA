...
function RichHtmlEmbed({ block }: { block: BlogHtmlBlock }) {
  return (
    <div
      className="rounded-xl bg-white/70 p-1 [&_a]:text-[#0f766e] [&_a]:underline [&_img]:max-w-full [&_img]:rounded-2xl [&_ol]:list-decimal [&_ol]:pl-6 [&_table]:w-full [&_table]:border-collapse [&_td]:border [&_td]:border-[#E3EAEA] [&_td]:px-3 [&_td]:py-2 [&_th]:border [&_th]:border-[#E3EAEA] [&_th]:bg-[#F7FAFA] [&_th]:px-3 [&_th]:py-2 [&_ul]:list-disc [&_ul]:pl-6 [&_video]:h-auto [&_video]:max-w-full"
